...
const Hero = () => (
  <motion.section
    ...
    whileInView="visible"
    id="home"
    className={`flex md:flex-row flex-col py-16`}
  >
    <motion.div custom={1} variants={textAnimation} className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        ...
        специализируется на широком спектре услуг, обеспечивающих комфорт и безопасность участников жиздедеятельности здания,
        осуществляя монтажные и пусконаладочные работы любой сложности.
      </p>
    </motion.div>

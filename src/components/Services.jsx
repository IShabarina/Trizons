...
const Services = () => (
  <motion.section
    ...
    <motion.div
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Выполняем монтаж и ремонт существующих инженерных коммуникаций привлекая наших постоянных опытных сотрудников, готовых решить любую сложную задачу и используя современное оборудование и инструменты</p>

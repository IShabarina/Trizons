import { send, shield, star, rubezh, bolid, sonar, rvi, hikvision, argusspector, interm, pozhtehtika, perco, /*shtemenkoVideo, shtemenkoImg, */ poliklinnikaProfsImg, poliklinnikaVvedenImg, poliklinnikaMillionImg, poliklinnikaPugachImg, komissariatVideo, komissariatImg, womenHealthImg, mchs1, mchs2, sro1, sro2, sro3, sro4 } from "../assets";
...
export const product = [
  {
    id: "product-1",
    title: "Кригскомиссариат",
    name: "Москва, Космодамианская набережная д.24, стр. 1 - 2023 год",
    content:
 ...
 // {
  ...
  //},
  {
    id: "product-2",
    content:
      "Проведены работы: устройство систем вентиляции, кондиционирования, а также слаботочных систем, в том числе пожарной сигнализации, дымоудаления и оповещения.",
    name: "Москва, ул. Введенского, д. 14А - 2023 год",
    title: "Моя поликлинника",
    img: poliklinnikaVvedenImg,
    video: poliklinnikaVvedenImg,
  },
   {
    id: "product-3",
    content:
      "Проведены работы: обеспечено электроосвещение и электроснабжение внутри здания, включая подключение розеток, стационарных приборов, осветительных приборов и щитового оборудования. Проведено устройство слаботочных систем.",
    name: "Москва, ул. Профсоюзная, д. 154, корп. 4 - 2024 год",
    title: "Моя поликлинника",
    img: poliklinnikaProfsImg,
    video: poliklinnikaProfsImg,
  },
     {
    id: "product-4",
    content:
      "Проведены работы:  устройство слаботочных систем",
    name: "Москва, ул. Академика Миллионщикова, д. 22 - 2024 год",
    title: "Моя поликлинника",
    img: poliklinnikaMillionImg,
    video: poliklinnikaMillionImg,
  },
    ...
    content:
      "Проведены работы:  устройство слаботочных систем",
    name: "Москва, ул. 2-я Пугачевская, д.8 - 2024 год",
    title: "Моя поликлинника",
    img: poliklinnikaPugachImg,
    video: poliklinnikaPugachImg,
  },
   {
    id: "product-9",
    content:
      "Проведены работы: обеспечено электроосвещение и электроснабжение внутри здания, включая подключение розеток, стационарных приборов, осветительных приборов и щитового оборудования. Проведено устройство слаботочных систем.",
    name: "г. Зеленоград, ул. Александровка, д. 8, стр. 3 - 2025 год",
    title: "Центр женского здоровья",
    img: womenHealthImg,
    video: womenHealthImg,
  }
];
